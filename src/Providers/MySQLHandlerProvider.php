...
/**
 * MysqlHandler to store the Monolog to mysql.
 *
 * based on wazaari\MysqlHandler
 */
class MySQLHandlerProvider extends AbstractProcessingHandler
{
    /**
    ...
    protected function write(array $record)
    {
        ...
        $contentArray = array_merge(array(
            ...
            'app' => env('APP_NAME', 'wind'),
            'user' => env('APP_DEVELOPER', 'sdun'),
        ), $record['context']);
